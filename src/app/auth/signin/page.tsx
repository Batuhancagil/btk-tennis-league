...
import { Mail, Lock, ArrowRight, Tennis } from "lucide-react"
    ...
    <main className="min-h-screen tennis-gradient-hero relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
          <h2 className="text-2xl font-bold text-gray-900 mb-2 text-center">Hoş Geldiniz</h2>
          <p className="text-gray-600 text-center mb-6">Hesabınıza giriş yapın</p>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-white border-2 border-gray-300 rounded-xl px-6 py-3 flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-400 transition-all font-medium text-gray-700"
            >
            ...
            <button
              ...
              className="w-full bg-gray-900 text-white rounded-xl px-6 py-3 flex items-center justify-center gap-3 hover:bg-gray-800 transition-all font-medium"
            >
...
export default function SignInPage() {
  return (
    <Suspense fallback={
      <main className="flex min-h-screen flex-col items-center justify-center tennis-gradient-hero p-24">
        <div className="z-10 max-w-md w-full">
          <div className="text-center mb-8">
            <div className="bg-tennis-black px-6 py-4 rounded-xl inline-block mb-4">
              <span className="text-5xl font-bold text-white">BTK</span>
            </div>
            <div className="text-xl font-semibold text-tennis-gold">tennis kommunity</div>
          </div>
          <div className="space-y-4">
            <div className="w-full bg-white/20 border border-white/30 rounded-xl px-6 py-3 h-12 animate-pulse" />
            <div className="w-full bg-white/20 border border-white/30 rounded-xl px-6 py-3 h-12 animate-pulse" />
          </div>
        </div>
      </main>
